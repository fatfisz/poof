...
Object.keys(_validator2['default']).filter(function (name) {
  ...
  assert[validatorName] = (0, _create_validator_decorator2['default'])(validatorFn, false);
  assert.not[validatorName] = (0, _create_validator_decorator2['default'])(validatorFn, true);
});
